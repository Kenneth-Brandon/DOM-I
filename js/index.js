...
const topContentParagraph = document.querySelectorAll(
  ".main-content .top-content p"
);
topContentParagraph[0].textContent =
  siteContent["main-content"]["features-content"];
topContentParagraph[1].textContent =
...
const bottomContentHeader = document.querySelectorAll(
...
const bottomParagraph = document.querySelectorAll(
